...
def main(opt):
    ...
    # subprocess.call(['python', os.path.join(os.getcwd(), 'scripts\\train\\few_shot\\run_train.py')] + format_opts(model_opt))
    subprocess.call(['python',  'run_train.py'] + format_opts(model_opt))
